...
document.getElementById('t33').style.backgroundColor=''
	...
	document.getElementById("p5").innerHTML='#new types:'
	document.getElementById("p3").innerHTML=''
...
function valid2(c)
{
 ...
 if(document.getElementById('t33').value==c)
{
	document.getElementById('t33').style.backgroundColor='green'
	document.getElementById('p6').innerHTML='<span style=\'color:green;font-size:30px\'>Right Answer</span>'

}
else if(document.getElementById('t33').value!=c )
{
	document.getElementById('t33').style.backgroundColor='red'
	document.getElementById('p6').innerHTML='<span style=\'color:red;font-size:30px\'>Wrong Answer</span>'
}
