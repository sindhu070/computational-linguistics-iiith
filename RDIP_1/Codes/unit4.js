...
function reappear()
{
	...
	document.getElementById("p3").innerHTML="#newtokens:"+"<br>"+"<input type='text'>"
...
document.getElementById("b2").addEventListener("click", reappear);
document.getElementById("b2").addEventListener("click", wow);
